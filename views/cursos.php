...
<body>
    ...
    <div class="container">
        ...
        <div class="modal fade" id="modal-cursos" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
                ...
                <form action="" id="registro-cursos">
                  <div class="row">
                    <div class="mb-3 col-lg-6">
                      ...
                      <input type="text" class="form-control" id="curso" placeholder="nombre curso" maxlength="100">
                    </div>
                    <div class="mb-3 col-lg-6">
                      <label for="creditos" class="form-label">Creditos:</label>
                      <input type="text" class="form-control" placeholder="horas" id="creditos" >
                    </div>
                </form>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-primary" id="actualizarcurso">Actualizar</button>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const modal = new bootstrap.Modal(document.querySelector("#modal-cursos"));
                    ...
                    datos.forEach(element => {
                        ...
                        <tr clas="text-center">
                            ...
                            <td >
                                ...
                                <a href='#' class='editar btn btn-info btn-sm' data-bs-toggle="modal" data-bs-target="#modal-cursos" data-idcurso='${element.idcurso}'>Editar</a>
                            </td>
                        </tr>
                        `;
            ...
            cuerpo.addEventListener("click", (event) => {
                if(event.target.classList[0] === 'editar'){
                    ...
                    const parametros = new URLSearchParams();
                    parametros.append("operacion", "obtenercur");
                    parametros.append("idcurso",idcurso);
                    ...
                    .then(response => response.json())
                    .then(datos => {
                        document.querySelector("#curso").value = datos.curso;
            ...
            btnactualizar.addEventListener("click",actualizarcursos);
            mostrar();
