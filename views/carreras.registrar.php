    ...
    <div class="container mt-3 col-4">
        <div class="card">
            <div class="card-header bg-success-subtle text-black">
                <h4 class="text-center">DATOS DE LA CARRERA</h4>
            </div>
            <div class="card-body" >
                <form action="" id="form-carrera">
                <div class="row">
                        <div class="col-lg-12" >
                            <label for="carrera" class="form-label">Carrera:</label>
                            <div class="input-group mb-3 ">
                                <span class="input-group-text" id="basic-addon1"><i class='bx bxs-graduation' ></i></span>
                                <input type="text" class="form-control" placeholder="Escriba" aria-label="Username" aria-describedby="basic-addon1" id="carrera">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            ...
                            <div class="input-group mb-3 ">
                                ...
                                <input type="text" class="form-control" maxlength="8" placeholder="meses/años" aria-label="Username" aria-describedby="basic-addon1" id="duracion">
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <label for="costo" class="form-label">Costo:</label>
                            <div class="input-group mb-3 ">
                                <span class="input-group-text" id="basic-addon1"><i class='bx bx-credit-card' ></i></span>
                                <input type="text" class="form-control" maxlength="8" placeholder="S/.00" aria-label="Username" aria-describedby="basic-addon1" id="costo">
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", () => {
                ...
                if(confirm("¿Está seguro de registrar?")){
                    ...
                    .then(datos =>{
                        if(datos.status){
                            ...
                            document.querySelector("#form-carrera").reset();
                            document.querySelector("#carrera").focus();
                        }else{
                            Swal.fire({
                                icon: "error",
                                title: (datos.message),
            ...
            function Limpiarformulario(){
                document.querySelector("#form-carrera").reset();
                documentq.querySelector("#carrera").focus();
            }
            // eventos
