...
<body>
    ...
    <div class="container mt-3 col-8">
        <div class="card">
            <div class="card-header bg-danger-subtle text-black">
                <h4 class="text-center">DATOS DEL DOCENTE</h4>
            </div>
            <div class="card-body" >
                <form action="" id="form-docentes">
                <div class="row">
                        <div class="col-lg-6" >
                            <label for="nombres" class="form-label">Nombres:</label>
                            <div class="input-group mb-3 ">
                                <span class="input-group-text" id="basic-addon1"><i class='bx bx-male-female' ></i></span>
                                <input type="text" class="form-control" placeholder="Escriba" aria-label="Username" aria-describedby="basic-addon1" id="nombres">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <label for="documento" class="form-label">N° Doc:</label>
                            <div class="input-group mb-3 ">
                                <span class="input-group-text" id="basic-addon1"><i class='bx bx-id-card' ></i></span>
                                <input type="text" class="form-control" maxlength="8" placeholder="N° DNI" aria-label="Username" aria-describedby="basic-addon1" id="documento">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <label for="fechamac" class="form-label">F.Nacimiento:</label>
                            <div class="input-group mb-3 ">
                                <span class="input-group-text" id="basic-addon1"><i class='bx bx-calendar-check' ></i></span>
                                <input type="date" class="form-control"  aria-label="Username" aria-describedby="basic-addon1" id="fechanac">
                            </div>
                        </div>
                        <div class="col-lg-6" >
                            <label for="telefono" class="form-label">Teléfono:</label>
                            <div class="input-group mb-3 ">
                                <span class="input-group-text" id="basic-addon1"><i class='bx bxs-phone-call' ></i></span>
                                <input type="tel" class="form-control" placeholder="número DNI" aria-label="Username" aria-describedby="basic-addon1" id="telefono" maxlength="9">
                            </div>
                        </div>
                        <div class="col-lg-6" >
                            ...
                            <div class="input-group mb-3 ">
                                ...
                                <input type="email" class="form-control" placeholder="correo@ejemplo.com" aria-label="Username" aria-describedby="basic-addon1" id="correo">
                            </div>
                        </div>
                        <div class="col-lg-6" >
                            <label for="direccion" class="form-label">Dirección:</label>
                            <div class="input-group mb-3 ">
                                <span class="input-group-text" id="basic-addon1"><i class='bx bxs-direction-right' ></i></span>
                                <input type="text" class="form-control" placeholder="Escriba" aria-label="Username" aria-describedby="basic-addon1" id="direccion">
                            </div>
                        </div>
                        <div class="col-lg-6" >
                            ...
                            <div class="input-group mb-3 ">
                                ...
                                <input type="text" class="form-control" placeholder="Escriba" aria-label="Username" aria-describedby="basic-addon1" id="especialidad">
                            </div>
                        </div>
